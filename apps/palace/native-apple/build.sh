...
xcrun swiftc -module-cache-path "$native_dir/build/module-cache" -framework AppKit -framework MapKit "$native_dir/main.swift" -o "$bundle_dir/Contents/MacOS/HaasomeApple"
